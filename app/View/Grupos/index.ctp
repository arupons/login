<div class="grupos index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('<i class="icon-eye-open"></i> Ver'), array('action' => 'view', $grupo['Grupo']['id']), array('class' => 'btn btn-info', 'escape' => false)); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
...
<br/>
		<?php echo $this->Html->link(__('<i class="icon-plus"></i> Ingresar Grupo'), array('action' => 'add'), array('class' => 'btn btn-success', 'escape' => false)); ?>
